...
<div class="main-columns">
  ...
  <div class="row"><?php if( $SPAN[0] ): ?>
   ...
   <div id="sidebar-main" class="col-md-<?php echo $SPAN[1];?>"><div id="content"><?php echo $content_top; ?>
      ...
      <?php } ?>
      <div class="container">
      <div class="content-inner contact-form">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="feature-box">
                                        <div class="fbox-icon">
                                            <i class="icons icons-bodered icons-lg radius-x fa fa-home"></i>
                                        </div>
                                        <div class="fbox-body">                            
                                            <h4 class="fbox-title"><?php echo $store; ?></h4>
                                ...
                                <div class="col-md-4">
                                    <div class="feature-box">
                                        <div class="fbox-icon">
                                            <a href="#"><i class="icons icons-bodered icons-lg radius-x fa fa-phone"></i></a>
                                        </div>
                                        <div class="fbox-body">
                                            <h4 class="fbox-title"><?php echo $text_telephone; ?></h4>
                                            <?php echo $text_telephone; ?>:<?php echo $telephone; ?><br />
                                            <?php if ($fax) { ?>
                                            <?php echo $text_fax; ?>:<?php echo $fax; ?>                                            
                                            <?php } ?>                               
                                        </div>
                                    </div>   
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="feature-box">
                                        <div class="fbox-icon">
                                            <a href="#"><i class="icons icons-bodered icons-lg radius-x fa fa-html5"></i></a>
                                        </div>
                                        <div class="fbox-body">
                                            <h4 class="fbox-title"><?php echo $text_open; ?></h4>
                                            <p><?php echo $html; ?>.</p>
                                        </div>
                                    </div>      
                                </div>
