<?php $id = rand(1,10); $span =  12/$columns; ?>
   <div id="pavcarousel<?php echo $id;?>" class="widget-carousel box carousel owl-carousel-play carousel-ed space-padding-tb-80 slide <?php echo $addition_cls ?>  <?php if( isset($stylecls)&&$stylecls ) { ?>box-<?php echo $stylecls;?><?php } ?>">
	<?php if( $show_title ) { ?>
