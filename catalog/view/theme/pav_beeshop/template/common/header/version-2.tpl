...
<div id="header-layout" class="bg-headermain header-v2">  
   <?php  require( ThemeControlHelper::getLayoutPath( 'common/addon/topbar-v1.tpl' ) );?>
   <div id="header-main">
      <div class="container">
      <div class="row">
        <div class="logo inner  col-lg-6 col-md-6 col-sm-3">
        ...
        <div class=" inner col-lg-4 col-md-5 col-sm-6 col-lg-offset-2 col-md-offset-1">
          <div class="call-top pull-left">
            <?php
    ...
    <div id="header-bot">
      <div class="container">
        ...
        <div id="pav-mainnav" class="hidden-xs hidden-sm pull-left pav-mainnav-v3">
